...
export const Route = createFileRoute('/app/admin/list/logs/weight/$clientId')({
  component: AdminWeightLogsRoute,
})

function AdminWeightLogsRoute() {
      ...
      {weightLogs && weightLogs.length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Change from Last</p>
                ...
                <p className="text-xs text-muted-foreground">({weightChangePercent}%)</p>
              </div>
            </CardContent>
          </Card>
      ...
      {!weightLogs ? (
        ...
        <>
          <Card>
            ...
            <CardContent>
              <ChartContainer config={weightChartConfig} className="h-80 w-full">
