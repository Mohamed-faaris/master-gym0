...
export const Route = createFileRoute('/app/_user/routines/$routineId')({
  component: RoutineEditorComponent,
})

function RoutineEditorComponent() {
  ...
  const removeExercise = (index: number) => {
    ...
    const normalizedExercises = clearSupersetGroup(newExercises, removedGroupId)
