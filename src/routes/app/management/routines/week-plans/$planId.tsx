...
export const Route = createFileRoute('/app/management/routines/week-plans/$planId')({
  component: ManagementWorkoutWeekPlanRoute,
})

function ManagementWorkoutWeekPlanRoute() {
